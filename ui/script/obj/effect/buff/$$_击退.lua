...
local mt = {
    ['LaunchMissileDash_1'] = {
        ...
        ['DoImpactUnit'] = true,
        ['FinalEffect'] = '$$.buff.击退.RemoveBuff_1',
        ['FinishActors'] = {
        },
        ['FinishEffect'] = '',
        ['ImpactActors'] = {
        ...
        ['Link'] = '$$.buff.击退.LaunchMissileDash_1',
        ['user_data'] = user_data['$$.buff.击退'],
    ...
    ['PersistLoop_1'] = {
        ...
        ['PeriodicEffect'] = '$$.buff.击退.LaunchMissileDash_1',
        ['PersistFlags'] = {
            ['Channeled'] = false,
            ['Channeling'] = false,
            ['FinishStage'] = false,
