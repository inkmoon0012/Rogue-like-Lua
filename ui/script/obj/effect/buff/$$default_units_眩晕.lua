...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.buff.眩晕'],
    ...
    ['Model_1'] = {
        ...
        ['Asset'] = 'effect/SampleSpells/Stormbolt/General_Stun/particle.effect',
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.buff.眩晕.Model_1',
        ['user_data'] = user_data['$$default_units.buff.眩晕'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
