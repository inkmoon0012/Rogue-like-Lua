...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$.spell.召唤水元素'],
    ...
    ['BuffTargetsAddTarget_1'] = {
        ...
        ['Link'] = '$$.spell.召唤水元素.BuffTargetsAddTarget_1',
        ['user_data'] = user_data['$$.spell.召唤水元素'],
        ['event'] = event_register
    },
    ['BuffTargetsClear_1'] = {
        ...
        ['Link'] = '$$.spell.召唤水元素.BuffTargetsClear_1',
        ['user_data'] = user_data['$$.spell.召唤水元素'],
        ['event'] = event_register
    },
    ['BuffTargetsEnum_1'] = {
        ...
        ['Link'] = '$$.spell.召唤水元素.BuffTargetsEnum_1',
        ['user_data'] = user_data['$$.spell.召唤水元素'],
        ['event'] = event_register
    },
    ['CreateUnit_1'] = {
    ...
    ['PolarOffset_1'] = {
        ...
        ['PointLocalVar'] = '',
        ['SuppressValidatorFailOutput'] = false,
        ['TargetEffect'] = '$$.spell.召唤水元素.RandomDelay_1',
        ['TargetLocation'] = {
            ['Effect'] = '',
            ['LocalVar'] = 'A',
            ['Value'] = 'Default',
        ...
        ['Link'] = '$$.spell.召唤水元素.PolarOffset_1',
        ['user_data'] = user_data['$$.spell.召唤水元素'],
        ['event'] = event_register
    },
    ['PolarOffset_2'] = {
        ...
        ['PointLocalVar'] = '',
        ['SuppressValidatorFailOutput'] = false,
        ['TargetEffect'] = '$$.spell.召唤水元素.RandomDelay_2',
        ['TargetLocation'] = {
            ['Effect'] = '',
            ['LocalVar'] = 'A',
            ['Value'] = 'Default',
        ...
        ['NodeType'] = 'EffectPolarOffset',
        ['Template'] = 'EffectPolarOffset',
        ['Link'] = '$$.spell.召唤水元素.PolarOffset_2',
        ['user_data'] = user_data['$$.spell.召唤水元素'],
        ['event'] = event_register
    },
    ['RandomDelay_1'] = {
        ['ActorArray'] = {
            [1] = '$$.spell.召唤水元素.ActorEffect_1',
        },
        ['BaseAmount'] = (function ()
            local func = function (ref_param)
                return 0.5
        ...
        ['Effect'] = '$$.spell.召唤水元素.CreateUnit_1',
        ['Name'] = '随机延迟节点_1',
        ...
        ['Link'] = '$$.spell.召唤水元素.RandomDelay_1',
        ['user_data'] = user_data['$$.spell.召唤水元素'],
        ['event'] = event_register
    },
    ['RandomDelay_2'] = {
        ['ActorArray'] = {
            [1] = '$$.spell.召唤水元素.ActorEffect_2',
        },
        ['BaseAmount'] = (function ()
            local func = function (ref_param)
                return 0.01
        ...
        ['NodeType'] = 'EffectRandomDelay',
        ['Template'] = 'EffectRandomDelay',
        ['Link'] = '$$.spell.召唤水元素.RandomDelay_2',
        ['user_data'] = user_data['$$.spell.召唤水元素'],
        ['event'] = event_register
    },
    ['RemoveBuff_1'] = {
    ...
    ['Set_1'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$.spell.召唤水元素.AddBuff_1',
            [2] = '',
            [3] = '$$.spell.召唤水元素.PolarOffset_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
    ...
    ['Set_2'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$.spell.召唤水元素.BuffTargetsAddTarget_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_2',
    ...
    ['Set_4'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$.spell.召唤水元素.BuffTargetsEnum_1',
            [2] = '$$.spell.召唤水元素.BuffTargetsClear_1',
            [3] = '$$.spell.召唤水元素.RemoveBuff_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_4',
    ...
    ['Set_6'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$.spell.召唤水元素.PolarOffset_2',
            [2] = '$$.spell.召唤水元素.UnitRemove_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_6',
            ...
            [1] = {
                ...
                ['Validator'] = (function ()
                    ...
                    local function func(效果节点)
                        ...
                        local level2 = base.unit_get_attribute(base.eff_param_caster(效果节点), "冰霜召唤师秘籍")
    ...
    ['root'] = {
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_04.ani',
        },
        ['EditorCategory'] = nil,
        ...
        ['SpellAnim'] = {
            ['Animation'] = 'human/barehanded_anim/hand_05/skill_04.ani',
