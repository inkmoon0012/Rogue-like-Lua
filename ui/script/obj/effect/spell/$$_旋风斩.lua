...
local mt = {
    ...
    ['PersistLoop_1'] = {
        ...
        ['PeriodicEffect'] = '$$.spell.旋风斩.Search_1',
        ['PersistFlags'] = {
            ['Channeled'] = false,
            ['Channeling'] = false,
            ['FinishStage'] = false,
        ...
        ['Link'] = '$$.spell.旋风斩.PersistLoop_1',
        ['user_data'] = user_data['$$.spell.旋风斩'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ['ActorArray'] = {
            [1] = '$$.spell.旋风斩.ActorEffect_1',
        },
        ['Angle'] = {
            ['LocalOffset'] = 0,
            ['Location'] = {
    ...
    ['Set_2'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$.spell.旋风斩.Damage_1',
            [2] = '$$.spell.旋风斩.AddBuff_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_2',
    ...
    ['root'] = {
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_020_b.ani',
        },
        ['EditorCategory'] = nil,
        ...
        ['SpellAnim'] = {
            ['Animation'] = 'human/barehanded_anim/hand_05/skill_020_b.ani',
