...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.三火球'],
    ...
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.三火球.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.三火球'],
        ['event'] = event_register
    },
    ['LaunchMissile_1'] = {
        ...
        ['FinishEffect'] = '',
        ['ImpactActors'] = {
            [1] = '$$default_units.spell.三火球.ActorEffect_1',
        },
        ['ImpactEffect'] = '$$default_units.spell.三火球.Damage_1',
        ...
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.spell.三火球.UnitMissile_1',
        ['Name'] = '发射投射物节点_1',
        ...
        ['Link'] = '$$default_units.spell.三火球.LaunchMissile_1',
        ['user_data'] = user_data['$$default_units.spell.三火球'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['PersistLoop_1'] = {
        ...
        ['PeriodicEffect'] = '$$default_units.spell.三火球.PolarOffset_1',
        ['PersistFlags'] = {
            ['Channeled'] = false,
            ['Channeling'] = false,
            ['FinishStage'] = false,
        ...
        ['Link'] = '$$default_units.spell.三火球.PersistLoop_1',
        ['user_data'] = user_data['$$default_units.spell.三火球'],
        ['event'] = event_register
    },
    ['PolarOffset_1'] = {
        ...
        ['PointLocalVar'] = '',
        ['SuppressValidatorFailOutput'] = false,
        ['TargetEffect'] = '$$default_units.spell.三火球.LaunchMissile_1',
        ['TargetLocation'] = {
            ['Effect'] = '',
            ['LocalVar'] = 'A',
            ['Value'] = 'Default',
        ...
        ['Link'] = '$$default_units.spell.三火球.PolarOffset_1',
        ['user_data'] = user_data['$$default_units.spell.三火球'],
        ['event'] = event_register
    },
    ['UnitMissile_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.spell.三火球.UnitMissile_1',
        ['user_data'] = user_data['$$default_units.spell.三火球'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['TargetUnitSorts'] = {
            ...
            [2] = '$$default_units.func_ref.优先上次施法的目标.root',
        },
        ['Time'] = {
            ['cast_channel_time'] = 0,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.三火球.root',
        ['user_data'] = user_data['$$default_units.spell.三火球'],
        ['event'] = event_register
    },
}
