...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.修理'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.修理.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.修理.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.修理'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.修理.AddBuff_1',
        ['SearchFilter'] = '单位,箭塔,建筑;',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.修理.Search_1',
        ['user_data'] = user_data['$$default_units.spell.修理'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.修理.root',
        ['user_data'] = user_data['$$default_units.spell.修理'],
        ['event'] = event_register
    },
}
