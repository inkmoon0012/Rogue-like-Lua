...
local mt = {
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.冲锋陷阵.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.冲锋陷阵'],
    ...
    ['LaunchMissileDash_1'] = {
        ...
        ['FinishEffect'] = '$$default_units.spell.冲锋陷阵.Search_1',
        ['ImpactActors'] = {
        },
        ['ImpactEffect'] = '',
        ...
        ['Link'] = '$$default_units.spell.冲锋陷阵.LaunchMissileDash_1',
        ['user_data'] = user_data['$$default_units.spell.冲锋陷阵'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.冲锋陷阵.Damage_1',
        ...
        ['Link'] = '$$default_units.spell.冲锋陷阵.Search_1',
        ['user_data'] = user_data['$$default_units.spell.冲锋陷阵'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.冲锋陷阵.root',
        ['user_data'] = user_data['$$default_units.spell.冲锋陷阵'],
        ['event'] = event_register
    },
}
