...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.剑刃风暴'],
        ['event'] = event_register
    },
    ['AddBuff_2'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.剑刃风暴.Buff_2',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.剑刃风暴.AddBuff_2',
        ['user_data'] = user_data['$$default_units.spell.剑刃风暴'],
        ['event'] = event_register
    },
    ['Buff_2'] = {
    ...
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.剑刃风暴.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.剑刃风暴'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.剑刃风暴.Damage_1',
        ['SearchFilter'] = '敌方,单位,地面;自身,无敌,死亡',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.剑刃风暴.Search_1',
        ['user_data'] = user_data['$$default_units.spell.剑刃风暴'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/blade_anim/doublehold_02/skill_02.ani',
        },
        ['EditorCategory'] = {
            [1] = 'Damage',
        },
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.剑刃风暴.root',
        ['user_data'] = user_data['$$default_units.spell.剑刃风暴'],
        ['event'] = event_register
    },
}
