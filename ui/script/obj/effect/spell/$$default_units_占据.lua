...
local mt = {
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.占据.UnitModifyOwner_1',
        ['SearchFilter'] = '敌方,单位;自身,无敌,死亡,英雄',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.占据.Search_1',
        ['user_data'] = user_data['$$default_units.spell.占据'],
    ...
    ['UnitModifyOwner_1'] = {
        ...
        ['Link'] = '$$default_units.spell.占据.UnitModifyOwner_1',
        ['user_data'] = user_data['$$default_units.spell.占据'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_030.ani',
        },
        ['EditorCategory'] = nil,
        ...
        ['SpellAnim'] = {
            ['Animation'] = 'human/barehanded_anim/hand_05/skill_030.ani',
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.占据.root',
        ['user_data'] = user_data['$$default_units.spell.占据'],
        ['event'] = event_register
    },
}
