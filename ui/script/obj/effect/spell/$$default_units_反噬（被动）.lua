...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.反噬（被动）'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = {
        },
        ['BuffLink'] = '$$default_units.spell.反噬（被动）.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.反噬（被动）.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.反噬（被动）'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.反噬（被动）.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.反噬（被动）'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['ResponseDamageAttacker_1'] = {
        ...
        ['ResponseEffect'] = '$$default_units.spell.反噬（被动）.Set_1',
        ...
        ['Template'] = 'Response',
        ['Link'] = '$$default_units.spell.反噬（被动）.ResponseDamageAttacker_1',
        ['user_data'] = user_data['$$default_units.spell.反噬（被动）'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.反噬（被动）.ActorEffect_1',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.反噬（被动）.UnitModifyAttribute_1',
            [2] = '$$default_units.spell.反噬（被动）.Damage_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.反噬（被动）.Set_1',
        ['user_data'] = user_data['$$default_units.spell.反噬（被动）'],
        ['event'] = event_register
    },
    ['UnitModifyAttribute_1'] = {
        ...
        ['Link'] = '$$default_units.spell.反噬（被动）.UnitModifyAttribute_1',
        ['user_data'] = user_data['$$default_units.spell.反噬（被动）'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '冷却时间：<node-value node="root" field = "Game.cool"/>\r\n每次削减<node-value node="UnitModifyAttribute_1" field = "Game.KeyValuePairs[1].Value"/>点法力值\r\n并造成<node-value node="Damage_1" field = "Game.Amount"/>伤害',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.反噬（被动）.root',
        ['user_data'] = user_data['$$default_units.spell.反噬（被动）'],
        ['event'] = event_register
    },
}
