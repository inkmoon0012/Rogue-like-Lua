...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.吸血光环'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.吸血光环.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.吸血光环.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.吸血光环'],
        ['event'] = event_register
    },
    ['AddBuff_1_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.吸血光环.Buff_2',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
                return 1
        ...
        ['NodeType'] = 'EffectAddBuff',
        ['Template'] = 'EffectAddBuff',
        ['Link'] = '$$default_units.spell.吸血光环.AddBuff_1_1',
        ['user_data'] = user_data['$$default_units.spell.吸血光环'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['ResponseDamageAttacker_1'] = {
        ...
        ['Modification'] = (function ()
                        --- lua_plus ---
            local function func(效果节点, 引发响应的效果节点, 原始伤害值, 当前伤害值)
                local result = 0
                local 新变量1 = 原始伤害值
        ...
        ['Template'] = 'Response',
        ['Link'] = '$$default_units.spell.吸血光环.ResponseDamageAttacker_1',
        ['user_data'] = user_data['$$default_units.spell.吸血光环'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.吸血光环.AddBuff_1',
        ['SearchFilter'] = '盟友,单位;自身,敌方,无敌,死亡',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.吸血光环.Search_1',
        ['user_data'] = user_data['$$default_units.spell.吸血光环'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.吸血光环.root',
        ['user_data'] = user_data['$$default_units.spell.吸血光环'],
        ['event'] = event_register
    },
}
