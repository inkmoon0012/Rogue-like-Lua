...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.咆哮'],
    ...
    ['AddBuff_1'] = {
        ...
        ['BuffLink'] = '$$default_units.spell.咆哮.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.咆哮.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.咆哮'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.咆哮.AddBuff_1',
        ['SearchFilter'] = '单位;敌方,无敌',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.咆哮.Search_1',
        ['user_data'] = user_data['$$default_units.spell.咆哮'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '冷却时间：<node-value node="root" field = "Game.cool"/>\r\n使周围<node-value node="Search_1" field = "Game.Radius"/>距离的友方单位，\r\n攻击力提高<node-value node="Buff_1" field = "Game.KeyValuePairs[1].Value"/>%，\r\n持续<node-value node="Buff_1" field = "Game.Duration"/>秒。',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.咆哮.root',
        ['user_data'] = user_data['$$default_units.spell.咆哮'],
        ['event'] = event_register
    },
}
