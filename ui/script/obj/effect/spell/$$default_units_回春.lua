...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.回春'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.回春.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.回春.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.回春'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.回春.AddBuff_1',
        ['SearchFilter'] = '单位;敌方,死亡',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.回春.Search_1',
        ['user_data'] = user_data['$$default_units.spell.回春'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.回春.Search_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.回春.Set_1',
        ['user_data'] = user_data['$$default_units.spell.回春'],
        ['event'] = event_register
    },
    ['UnitModifyAttribute_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.回春.ActorEffect_1',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
        ...
        ['Link'] = '$$default_units.spell.回春.UnitModifyAttribute_1',
        ['user_data'] = user_data['$$default_units.spell.回春'],
        ['event'] = event_register
    },
    ['root'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.回春.ActorEffect_4',
            [2] = '$$default_units.spell.回春.ActorEffect_2',
        },
        ['ClientSpell'] = {
            ['AfterCastParticles'] = {
            },
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.回春.root',
        ['user_data'] = user_data['$$default_units.spell.回春'],
        ['event'] = event_register
    },
}
