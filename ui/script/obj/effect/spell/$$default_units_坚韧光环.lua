...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.坚韧光环'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.坚韧光环.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.坚韧光环.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.坚韧光环'],
        ['event'] = event_register
    },
    ['AddBuff_2'] = {
        ...
        ['BuffLink'] = '$$default_units.spell.坚韧光环.Buff_2',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
                return 1
        ...
        ['NodeType'] = 'EffectAddBuff',
        ['Template'] = 'EffectAddBuff',
        ['Link'] = '$$default_units.spell.坚韧光环.AddBuff_2',
        ['user_data'] = user_data['$$default_units.spell.坚韧光环'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.坚韧光环.AddBuff_2',
        ['SearchFilter'] = '单位;中立,敌方,无敌,死亡',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.坚韧光环.Search_1',
        ['user_data'] = user_data['$$default_units.spell.坚韧光环'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '施法距离：<node-value node="Search_1" field = "Game.Radius"/>\r\n移动速度提高：<node-value node="Buff_2" field = "Game.KeyValuePairs[1].Value"/>%\r\n攻击速度速度提高：<node-value node="Buff_2" field = "Game.KeyValuePairs[2].Value"/>%',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.坚韧光环.root',
        ['user_data'] = user_data['$$default_units.spell.坚韧光环'],
        ['event'] = event_register
    },
}
