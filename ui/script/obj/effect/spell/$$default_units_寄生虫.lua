...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.寄生虫'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.寄生虫.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.寄生虫.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.寄生虫'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['CreateUnit_1'] = {
        ...
        ['SpawnUnitTypePerLevel'] = {
            [1] = '$$default_units.unit.爬虫.root',
        },
        ['SuppressValidatorFailOutput'] = false,
        ['TargetLocation'] = {
            ['Effect'] = '$$default_units.spell.寄生虫.AddBuff_1',
            ['LocalVar'] = 'A',
            ['Value'] = 'Target',
        },
        ['TargetType'] = 'Point',
        ...
        ['Link'] = '$$default_units.spell.寄生虫.CreateUnit_1',
        ['user_data'] = user_data['$$default_units.spell.寄生虫'],
        ['event'] = event_register
    },
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.寄生虫.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.寄生虫'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['ResponseDamageDefender_1'] = {
        ...
        ['ResponseEffect'] = '$$default_units.spell.寄生虫.CreateUnit_1',
        ...
        ['Template'] = 'Response',
        ['Link'] = '$$default_units.spell.寄生虫.ResponseDamageDefender_1',
        ['user_data'] = user_data['$$default_units.spell.寄生虫'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.寄生虫.AddBuff_1',
        ...
        ['Link'] = '$$default_units.spell.寄生虫.Search_1',
        ['user_data'] = user_data['$$default_units.spell.寄生虫'],
        ['event'] = event_register
    },
    ['root'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.寄生虫.ActorEffect_3',
        },
        ['ClientSpell'] = {
            ['AfterCastParticles'] = {
            },
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_027.ani',
        },
        ['EditorCategory'] = {
            [1] = 'Damage',
            [2] = 'Special',
        ...
        ['SpellAnim'] = {
            ['Animation'] = 'human/barehanded_anim/hand_05/skill_027.ani',
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.寄生虫.root',
        ['user_data'] = user_data['$$default_units.spell.寄生虫'],
        ['event'] = event_register
    },
}
