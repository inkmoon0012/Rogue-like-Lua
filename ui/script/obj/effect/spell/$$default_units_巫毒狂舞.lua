...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.巫毒狂舞'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.巫毒狂舞.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.巫毒狂舞.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.巫毒狂舞'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Model_1'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.spell.巫毒狂舞.Model_1',
        ['user_data'] = user_data['$$default_units.spell.巫毒狂舞'],
        ['event'] = event_register
    },
    ['Model_2'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.spell.巫毒狂舞.Model_2',
        ['user_data'] = user_data['$$default_units.spell.巫毒狂舞'],
        ['event'] = event_register
    },
    ['PersistLoop_1'] = {
        ...
        ['PeriodicEffect'] = '$$default_units.spell.巫毒狂舞.Search_1',
        ['PersistFlags'] = {
            ['Channeled'] = false,
            ['Channeling'] = true,
            ['FinishStage'] = false,
        ...
        ['Link'] = '$$default_units.spell.巫毒狂舞.PersistLoop_1',
        ['user_data'] = user_data['$$default_units.spell.巫毒狂舞'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.巫毒狂舞.AddBuff_1',
        ['SearchFilter'] = '盟友;自身,敌方,无敌',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.巫毒狂舞.Search_1',
        ['user_data'] = user_data['$$default_units.spell.巫毒狂舞'],
        ['event'] = event_register
    },
    ['root'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.巫毒狂舞.ActorEffect_4',
        },
        ['ClientSpell'] = {
            ['AfterCastParticles'] = {
            },
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/casting_01.ani',
        },
        ['EditorCategory'] = {
            [1] = 'Buff',
        },
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.巫毒狂舞.root',
        ['user_data'] = user_data['$$default_units.spell.巫毒狂舞'],
        ['event'] = event_register
    },
}
