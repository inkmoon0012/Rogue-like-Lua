...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.弱化之锤'],
    ...
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.弱化之锤.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.弱化之锤'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['RandomDelay_1'] = {
        ...
        ['Effect'] = '$$default_units.spell.弱化之锤.Search_1',
        ['Name'] = '随机延迟节点_1',
        ...
        ['Link'] = '$$default_units.spell.弱化之锤.RandomDelay_1',
        ['user_data'] = user_data['$$default_units.spell.弱化之锤'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.弱化之锤.Damage_1',
        ...
        ['Link'] = '$$default_units.spell.弱化之锤.Search_1',
        ['user_data'] = user_data['$$default_units.spell.弱化之锤'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.弱化之锤.ActorEffect_1',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.弱化之锤.RandomDelay_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.弱化之锤.Set_1',
        ['user_data'] = user_data['$$default_units.spell.弱化之锤'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '冷却时间：<node-value node="root" field = "Game.cool"/>\r\n施法距离：<node-value node="root" field = "Game.range"/>\r\n影响范围：<node-value node="root" field = "Game.distance"/>\r\n对区域内的敌人造成<node-value node="Damage_1" field = "Game.Amount"/>伤害',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.弱化之锤.root',
        ['user_data'] = user_data['$$default_units.spell.弱化之锤'],
        ['event'] = event_register
    },
}
