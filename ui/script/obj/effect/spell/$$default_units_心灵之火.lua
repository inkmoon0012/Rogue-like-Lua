...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.心灵之火'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.心灵之火.ActorEffect_2',
        },
        ['BuffLink'] = '$$default_units.spell.心灵之火.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.心灵之火.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.心灵之火'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.心灵之火.ActorEffect_1',
        },
        ['Angle'] = {
            ['LocalOffset'] = 0,
            ['Location'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.心灵之火.AddBuff_1',
        ['SearchFilter'] = '盟友,单位;敌方,无敌,死亡',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.心灵之火.Search_1',
        ['user_data'] = user_data['$$default_units.spell.心灵之火'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '施法距离：<node-value node="root" field = "Game.range"/>\r\n光标范围：<node-value node="root" field = "Game.distance"/>\r\n冷却时间：<node-value node="root" field = "Game.cool"/>\r\n搜索友军范围：<node-value node="Search_1" field = "Game.Radius"/>\r\nbuff效果持续时间：<node-value node="Buff_1" field = "Game.Duration"/>\r\n攻击力增加<node-value node="Buff_1" field = "Game.KeyValuePairs[1].Value"/>%\r\n护甲值增加<node-value node="Buff_1" field = "Game.KeyValuePairs[2].Value"/>',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.心灵之火.root',
        ['user_data'] = user_data['$$default_units.spell.心灵之火'],
        ['event'] = event_register
    },
}
