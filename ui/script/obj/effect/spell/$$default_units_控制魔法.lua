...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.控制魔法'],
    ...
    ['AddBuff_1'] = {
        ...
        ['BuffLink'] = '$$default_units.spell.控制魔法.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.控制魔法.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.控制魔法'],
        ['event'] = event_register
    },
    ['AddBuff_2'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.控制魔法.Buff_2',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
                return 1
        ...
        ['NodeType'] = 'EffectAddBuff',
        ['Template'] = 'EffectAddBuff',
        ['Link'] = '$$default_units.spell.控制魔法.AddBuff_2',
        ['user_data'] = user_data['$$default_units.spell.控制魔法'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['PersistLoop_1'] = {
        ...
        ['ExpireEffect'] = '$$default_units.spell.控制魔法.AddBuff_2',
        ['FinalEffect'] = '',
        ['InitialEffect'] = '$$default_units.spell.控制魔法.AddBuff_1',
        ['Name'] = '周期性节点_1',
        ['Period'] = (function ()
            local func = function (ref_param)
                return 0.3
        ...
        ['Link'] = '$$default_units.spell.控制魔法.PersistLoop_1',
        ['user_data'] = user_data['$$default_units.spell.控制魔法'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.控制魔法.PersistLoop_1',
        ...
        ['Link'] = '$$default_units.spell.控制魔法.Search_1',
        ['user_data'] = user_data['$$default_units.spell.控制魔法'],
        ['event'] = event_register
    },
    ['UnitModifyOwner_1'] = {
        ...
        ['ID'] = 'UnitModifyOwner_1',
        ['Class'] = 'effect',
        ['NodeType'] = 'EffectUnitModifyOwner',
        ['Template'] = 'EffectUnitModifyOwner',
        ['Link'] = '$$default_units.spell.控制魔法.UnitModifyOwner_1',
        ['user_data'] = user_data['$$default_units.spell.控制魔法'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.控制魔法.root',
        ['user_data'] = user_data['$$default_units.spell.控制魔法'],
        ['event'] = event_register
    },
}
