...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.放逐'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = {
        },
        ['BuffLink'] = '$$default_units.spell.放逐.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.放逐.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.放逐'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['RemoveBuff_1'] = {
        ...
        ['Link'] = '$$default_units.spell.放逐.RemoveBuff_1',
        ['user_data'] = user_data['$$default_units.spell.放逐'],
        ['event'] = event_register
    },
    ['ResponseDamageDefender_1'] = {
        ...
        ['Template'] = 'Response',
        ['Link'] = '$$default_units.spell.放逐.ResponseDamageDefender_1',
        ['user_data'] = user_data['$$default_units.spell.放逐'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.放逐.AddBuff_1',
        ...
        ['Link'] = '$$default_units.spell.放逐.Search_1',
        ['user_data'] = user_data['$$default_units.spell.放逐'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.放逐.root',
        ['user_data'] = user_data['$$default_units.spell.放逐'],
        ['event'] = event_register
    },
}
