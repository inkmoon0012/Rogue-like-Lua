...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.旋风斩'],
    ...
    ['AddBuff_1'] = {
        ...
        ['Chance'] = (function ()
            ...
            local function func(效果节点)
                local result = 0
                local level = base.unit_get_attribute(base.eff_param_target_unit(效果节点), "穿肠秘籍")
                result = 0.2 + 0.1 * level
                return result
            end
            return func
        end)(),
        ...
        ['Link'] = '$$default_units.spell.旋风斩.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.旋风斩'],
        ['event'] = event_register
    },
    ['Damage_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.旋风斩.ActorEffect_1',
        },
        ['Amount'] = (function ()
                        --- lua_plus ---
            --- skip_undefined ---
            local function func(效果节点)
                ...
                local level = base.unit_get_attribute(base.eff_param_caster(效果节点), "旋风斩等级")
                ...
                if CriticalRate >= Random100 then
                    Result = (Attack + 10 * level) * (1 - Resistance) * CriticalDamage
                else
                    Result = (Attack + 10 * level) * (1 - Resistance)
                end
                return Result
            end
            return func
        ...
        ['Link'] = '$$default_units.spell.旋风斩.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.旋风斩'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['PersistLoop_1'] = {
        ...
        ['PeriodicEffect'] = '$$default_units.spell.旋风斩.Search_1',
        ['PersistFlags'] = {
            ['Channeled'] = false,
            ['Channeling'] = true,
            ['FinishStage'] = false,
        ...
        ['Link'] = '$$default_units.spell.旋风斩.PersistLoop_1',
        ['user_data'] = user_data['$$default_units.spell.旋风斩'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.旋风斩.Set_1',
        ...
        ['Link'] = '$$default_units.spell.旋风斩.Search_1',
        ['user_data'] = user_data['$$default_units.spell.旋风斩'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.旋风斩.Damage_1',
            [2] = '$$default_units.spell.旋风斩.AddBuff_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.旋风斩.Set_1',
        ['user_data'] = user_data['$$default_units.spell.旋风斩'],
        ['event'] = event_register
    },
    ['root'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.旋风斩.ActorEffect_2',
        },
        ['ClientSpell'] = {
            ['AfterCastParticles'] = {
            },
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_dafengche.ani',
        },
        ['EditorCategory'] = {
            [1] = 'Damage',
        },
        ...
        ['SimpleText'] = '旋转时间：<node-value node="root" field = "Game.Time.cast_shot_time"/>\r\n冷却时间：<node-value node="root" field = "Game.cool"/>\r\n旋转次数：<node-value node="PersistLoop_1" field = "Game.PeriodicCount"/>\r\n旋转周期：<node-value node="PersistLoop_1" field = "Game.Period"/>\r\n伤害范围：<node-value node="Search_1" field = "Game.Radius"/>\r\n伤害值：<node-value node="Damage_1" field = "Game.Amount"/>',
        ['SimpleVideo'] = nil,
        ['SimpleVideoPreview'] = nil,
        ['SpellAnim'] = {
            ['Animation'] = 'human/barehanded_anim/hand_05/skill_dafengche.ani',
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.旋风斩.root',
        ['user_data'] = user_data['$$default_units.spell.旋风斩'],
        ['event'] = event_register
    },
}
