...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.无敌圣盾'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.无敌圣盾.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.无敌圣盾.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.无敌圣盾'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.无敌圣盾.root',
        ['user_data'] = user_data['$$default_units.spell.无敌圣盾'],
        ['event'] = event_register
    },
}
