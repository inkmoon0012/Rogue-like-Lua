...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.毒蛇结界（蛇棒）.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['CreateUnit_1'] = {
        ...
        ['SpawnCount'] = 1,
        ['SpawnEffect'] = '$$default_units.spell.毒蛇结界（蛇棒）.AddBuff_1',
        ['SpawnOffset'] = {
            ['Angle'] = {
                ['LocalOffset'] = 0,
                ['Location'] = {
        ...
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.CreateUnit_1',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['Damage_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.毒蛇结界（蛇棒）.ActorEffect_1',
        },
        ['Amount'] = (function ()
            local func = function (ref_param)
                return 15
        ...
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['LaunchMissileNoImpact_1'] = {
        ...
        ['FinishEffect'] = '$$default_units.spell.毒蛇结界（蛇棒）.Damage_1',
        ['ImpactActors'] = {
        },
        ['ImpactEffect'] = '',
        ...
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.spell.毒蛇结界（蛇棒）.UnitMissile_1',
        ...
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.LaunchMissileNoImpact_1',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.毒蛇结界（蛇棒）.LaunchMissileNoImpact_1',
        ...
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.Search_1',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['UnitMissile_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.UnitMissile_1',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['UnitRemove_1'] = {
        ...
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.UnitRemove_1',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.毒蛇结界（蛇棒）.root',
        ['user_data'] = user_data['$$default_units.spell.毒蛇结界（蛇棒）'],
        ['event'] = event_register
    },
}
