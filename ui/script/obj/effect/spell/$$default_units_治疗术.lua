...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.治疗术'],
    ...
    ['UnitModifyAttribute_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.治疗术.ActorEffect_1',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.治疗术.UnitModifyAttribute_1',
        ['user_data'] = user_data['$$default_units.spell.治疗术'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['StartEffect'] = '',
        ['TargetUnitFilter'] = '可见,单位;敌方,无敌,魔免,死亡',
        ['TargetUnitRange'] = 800,
        ['TargetUnitSorts'] = {
            [1] = '$$default_units.func_ref.lowest_health_rate_unit.root',
            [2] = '$$default_units.func_ref.优先施法者正前方120度内的单位.root',
            [3] = '$$default_units.func_ref.优先上次施法的目标.root',
        },
        ['Time'] = {
            ['cast_channel_time'] = 0,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.治疗术.root',
        ['user_data'] = user_data['$$default_units.spell.治疗术'],
        ['event'] = event_register
    },
}
