...
local mt = {
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.硬化体肤（被动）.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.硬化体肤（被动）.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.硬化体肤（被动）'],
    ...
    ['ResponseDamageDefender_1'] = {
        ...
        ['Template'] = 'Response',
        ['Link'] = '$$default_units.spell.硬化体肤（被动）.ResponseDamageDefender_1',
        ['user_data'] = user_data['$$default_units.spell.硬化体肤（被动）'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '降低<node-value node="ResponseDamageDefender_1" field = "Game.Modification"/>点',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.硬化体肤（被动）.root',
        ['user_data'] = user_data['$$default_units.spell.硬化体肤（被动）'],
        ['event'] = event_register
    },
}
