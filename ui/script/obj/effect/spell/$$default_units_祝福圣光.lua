...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
    ...
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.祝福圣光.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['RandomDelay_1'] = {
        ...
        ['Effect'] = '$$default_units.spell.祝福圣光.Set_2',
        ['Name'] = '随机延迟节点_1',
        ...
        ['Link'] = '$$default_units.spell.祝福圣光.RandomDelay_1',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.祝福圣光.UnitModifyAttribute_1',
        ['SearchFilter'] = '自身,盟友,单位;敌方,无敌,死亡',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.祝福圣光.Search_1',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
    ['Search_1_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.祝福圣光.Damage_1',
        ...
        ['NodeType'] = 'EffectSearch',
        ['Template'] = 'EffectSearch',
        ['Link'] = '$$default_units.spell.祝福圣光.Search_1_1',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.祝福圣光.ActorEffect_1',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.祝福圣光.RandomDelay_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.祝福圣光.Set_1',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
    ['Set_2'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.祝福圣光.Search_1',
            [2] = '$$default_units.spell.祝福圣光.Search_1_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_2',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.祝福圣光.Set_2',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
    ['UnitModifyAttribute_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.祝福圣光.ActorEffect_3',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
        ...
        ['Link'] = '$$default_units.spell.祝福圣光.UnitModifyAttribute_1',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.祝福圣光.root',
        ['user_data'] = user_data['$$default_units.spell.祝福圣光'],
        ['event'] = event_register
    },
}
