...
local mt = {
    ['PolarOffset_1'] = {
        ...
        ['TargetEffect'] = '$$default_units.spell.移形换影.Set_1',
        ['TargetLocation'] = {
            ['Effect'] = '',
            ['LocalVar'] = 'A',
            ['Value'] = 'Default',
        ...
        ['Link'] = '$$default_units.spell.移形换影.PolarOffset_1',
        ['user_data'] = user_data['$$default_units.spell.移形换影'],
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.移形换影.PolarOffset_1',
        ...
        ['Link'] = '$$default_units.spell.移形换影.Search_1',
        ['user_data'] = user_data['$$default_units.spell.移形换影'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.移形换影.Teleport_1',
            [2] = '$$default_units.spell.移形换影.Teleport_2',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.移形换影.Set_1',
        ['user_data'] = user_data['$$default_units.spell.移形换影'],
        ['event'] = event_register
    },
    ['Teleport_1'] = {
        ...
        ['WhichUnit'] = {
            ['Effect'] = '$$default_units.spell.移形换影.PolarOffset_1',
            ['LocalVar'] = 'A',
            ['Value'] = 'Target',
        },
        ['ID'] = 'Teleport_1',
        ...
        ['Link'] = '$$default_units.spell.移形换影.Teleport_1',
        ['user_data'] = user_data['$$default_units.spell.移形换影'],
        ['event'] = event_register
    },
    ['Teleport_2'] = {
        ...
        ['NodeType'] = 'EffectTeleport',
        ['Template'] = 'EffectTeleport',
        ['Link'] = '$$default_units.spell.移形换影.Teleport_2',
        ['user_data'] = user_data['$$default_units.spell.移形换影'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.移形换影.root',
        ['user_data'] = user_data['$$default_units.spell.移形换影'],
        ['event'] = event_register
    },
}
