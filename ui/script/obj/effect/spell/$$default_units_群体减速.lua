...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.群体减速'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.群体减速.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.群体减速.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.群体减速'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.群体减速.AddBuff_1',
        ['SearchFilter'] = '敌方;自身,无敌,魔免',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.群体减速.Search_1',
        ['user_data'] = user_data['$$default_units.spell.群体减速'],
        ['event'] = event_register
    },
    ['Set_2'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.群体减速.ActorEffect_1',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.群体减速.Search_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_2',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.群体减速.Set_2',
        ['user_data'] = user_data['$$default_units.spell.群体减速'],
        ['event'] = event_register
    },
    ['UnitModifyAttribute_1'] = {
        ...
        ['Link'] = '$$default_units.spell.群体减速.UnitModifyAttribute_1',
        ['user_data'] = user_data['$$default_units.spell.群体减速'],
        ['event'] = event_register
    },
    ['UnitModifyAttribute_1_1'] = {
        ...
        ['NodeType'] = 'EffectUnitModifyAttribute',
        ['Template'] = 'EffectUnitModifyAttribute',
        ['Link'] = '$$default_units.spell.群体减速.UnitModifyAttribute_1_1',
        ['user_data'] = user_data['$$default_units.spell.群体减速'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_018.ani',
        },
        ['EditorCategory'] = {
            [1] = 'Debuff',
        },
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.群体减速.root',
        ['user_data'] = user_data['$$default_units.spell.群体减速'],
        ['event'] = event_register
    },
}
