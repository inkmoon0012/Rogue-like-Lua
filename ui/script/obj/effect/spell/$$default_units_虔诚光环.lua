...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.虔诚光环'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.虔诚光环.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.虔诚光环.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.虔诚光环'],
        ['event'] = event_register
    },
    ['AddBuff_3'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.虔诚光环.Buff_3',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
                return 1
        ...
        ['NodeType'] = 'EffectAddBuff',
        ['Template'] = 'EffectAddBuff',
        ['Link'] = '$$default_units.spell.虔诚光环.AddBuff_3',
        ['user_data'] = user_data['$$default_units.spell.虔诚光环'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.虔诚光环.AddBuff_3',
        ['SearchFilter'] = '单位;自身,敌方',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.虔诚光环.Search_1',
        ['user_data'] = user_data['$$default_units.spell.虔诚光环'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '光环范围：<node-value node="root" field = "Game.range"/>\n增加护甲：<node-value node="Buff_2" field = "Game.KeyValuePairs[1].Value"/>',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.虔诚光环.root',
        ['user_data'] = user_data['$$default_units.spell.虔诚光环'],
        ['event'] = event_register
    },
}
