...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.蛇棒攻击'],
        ['event'] = event_register
    },
    ['Damage_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.蛇棒攻击.ActorEffect_1',
        },
        ['Amount'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.蛇棒攻击.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.蛇棒攻击'],
        ['event'] = event_register
    },
    ['LaunchMissileNoImpact_1'] = {
        ...
        ['FinishEffect'] = '$$default_units.spell.蛇棒攻击.Damage_1',
        ['ImpactActors'] = {
        },
        ['ImpactEffect'] = '',
        ...
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.spell.蛇棒攻击.UnitMissile_1',
        ...
        ['Link'] = '$$default_units.spell.蛇棒攻击.LaunchMissileNoImpact_1',
        ['user_data'] = user_data['$$default_units.spell.蛇棒攻击'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.蛇棒攻击.LaunchMissileNoImpact_1',
        ...
        ['Link'] = '$$default_units.spell.蛇棒攻击.Search_1',
        ['user_data'] = user_data['$$default_units.spell.蛇棒攻击'],
        ['event'] = event_register
    },
    ['UnitMissile_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.spell.蛇棒攻击.UnitMissile_1',
        ['user_data'] = user_data['$$default_units.spell.蛇棒攻击'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.蛇棒攻击.root',
        ['user_data'] = user_data['$$default_units.spell.蛇棒攻击'],
        ['event'] = event_register
    },
}
