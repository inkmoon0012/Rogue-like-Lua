...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.诅咒.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.诅咒.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Model_1'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.spell.诅咒.Model_1',
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
        ['event'] = event_register
    },
    ['Model_2'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.spell.诅咒.Model_2',
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
        ['event'] = event_register
    },
    ['ResponseMissileImpactAttacker_1'] = {
        ['Chance'] = (function ()
            local func = function (ref_param)
                return 0.33
            end
        ...
        ['ResponseEffect'] = '$$default_units.spell.诅咒.Set_1',
        ...
        ['temp_reflect_model'] = '',
        ['ID'] = 'ResponseMissileImpactAttacker_1',
        ['Class'] = 'response',
        ['NodeType'] = 'ResponseMissileImpact',
        ['Template'] = 'Response',
        ['Link'] = '$$default_units.spell.诅咒.ResponseMissileImpactAttacker_1',
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
        ['event'] = event_register
    },
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.诅咒.AddBuff_1',
        ['SearchFilter'] = '敌方,可见,单位;自身,同一玩家,盟友,中立,无敌,魔免,蝗虫,兵营,弹道,箭塔,建筑,基地,泉水,商店,守卫,物品',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.诅咒.Search_1',
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.诅咒.ActorEffect_2',
        },
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.诅咒.Set_1',
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.诅咒.root',
        ['user_data'] = user_data['$$default_units.spell.诅咒'],
        ['event'] = event_register
    },
}
