...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.诱捕'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.诱捕.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.诱捕.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.诱捕'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['LaunchMissileNoImpact_1'] = {
        ...
        ['FinishEffect'] = '$$default_units.spell.诱捕.Search_1',
        ['ImpactActors'] = {
        },
        ['ImpactEffect'] = '',
        ...
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.spell.诱捕.UnitMissile_1',
        ...
        ['Link'] = '$$default_units.spell.诱捕.LaunchMissileNoImpact_1',
        ['user_data'] = user_data['$$default_units.spell.诱捕'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['Search_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.诱捕.ActorEffect_3',
        },
        ['Angle'] = {
            ['LocalOffset'] = 0,
            ['Location'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.诱捕.AddBuff_1',
        ...
        ['Link'] = '$$default_units.spell.诱捕.Search_1',
        ['user_data'] = user_data['$$default_units.spell.诱捕'],
        ['event'] = event_register
    },
    ['UnitMissile_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.spell.诱捕.UnitMissile_1',
        ['user_data'] = user_data['$$default_units.spell.诱捕'],
        ['event'] = event_register
    },
    ['root'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.诱捕.ActorEffect_2',
        },
        ['ClientSpell'] = {
            ['AfterCastParticles'] = {
            },
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.诱捕.root',
        ['user_data'] = user_data['$$default_units.spell.诱捕'],
        ['event'] = event_register
    },
}
