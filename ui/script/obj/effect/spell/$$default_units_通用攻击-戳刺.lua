...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.通用攻击-戳刺'],
    ...
    ['Damage_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.通用攻击-戳刺.ActorEffect_1',
        },
        ['Amount'] = (function ()
                        --- lua_plus ---
        ...
        ['Link'] = '$$default_units.spell.通用攻击-戳刺.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.通用攻击-戳刺'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.通用攻击-戳刺.Damage_1',
        ...
        ['Link'] = '$$default_units.spell.通用攻击-戳刺.Search_1',
        ['user_data'] = user_data['$$default_units.spell.通用攻击-戳刺'],
        ['event'] = event_register
    },
    ['root'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.通用攻击-戳刺.ActorEffect_2',
        },
        ['ClientSpell'] = {
            ['AfterCastParticles'] = {
            },
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/blade_anim/twohand_01/attack_03.ani',
        },
        ['EditorCategory'] = nil,
        ...
        ['SpellAnim'] = {
            ['Animation'] = 'human/blade_anim/twohand_01/attack_03.ani',
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.通用攻击-戳刺.root',
        ['user_data'] = user_data['$$default_units.spell.通用攻击-戳刺'],
        ['event'] = event_register
    },
}
