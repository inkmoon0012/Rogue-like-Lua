...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.通用攻击-火球'],
    ...
    ['Damage_1'] = {
        ...
        ['Amount'] = (function ()
            ...
            local function func(效果节点)
                ...
                local level = base.unit_get_attribute(base.player_get_hero(base.player(1)), "召唤火焰卫士等级")
        ...
        ['Link'] = '$$default_units.spell.通用攻击-火球.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.通用攻击-火球'],
        ['event'] = event_register
    },
    ['LaunchMissile_1'] = {
        ...
        ['FinishEffect'] = '',
        ['ImpactActors'] = {
            [1] = '$$default_units.spell.通用攻击-火球.ActorEffect_1',
        },
        ['ImpactEffect'] = '$$default_units.spell.通用攻击-火球.Damage_1',
        ...
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.spell.通用攻击-火球.UnitMissile_1',
        ['Name'] = '发射投射物节点_1',
        ...
        ['Link'] = '$$default_units.spell.通用攻击-火球.LaunchMissile_1',
        ['user_data'] = user_data['$$default_units.spell.通用攻击-火球'],
        ['event'] = event_register
    },
    ['Particle_2'] = {
    ...
    ['UnitMissile_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.spell.通用攻击-火球.UnitMissile_1',
        ['user_data'] = user_data['$$default_units.spell.通用攻击-火球'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.通用攻击-火球.root',
        ['user_data'] = user_data['$$default_units.spell.通用攻击-火球'],
        ['event'] = event_register
    },
}
