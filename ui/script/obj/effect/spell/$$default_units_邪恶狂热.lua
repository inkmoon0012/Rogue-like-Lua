...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.邪恶狂热'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.邪恶狂热.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.邪恶狂热.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.邪恶狂热'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.spell.邪恶狂热.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.邪恶狂热'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.邪恶狂热.AddBuff_1',
        ['SearchFilter'] = '单位;自身,敌方,无敌,魔免,死亡',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.邪恶狂热.Search_1',
        ['user_data'] = user_data['$$default_units.spell.邪恶狂热'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['SimpleText'] = '冷却时间：<node-value node="root" field = "Game.cool"/>\r\n攻击速度提高：<node-value node="Buff_1" field = "Game.KeyValuePairs[1].Value"/>%\r\n每秒消耗生命值：<node-value node="Damage_1" field = "Game.Amount"/>\r\n持续：<node-value node="Buff_1" field = "Game.Duration"/>秒',
        ['SimpleVideo'] = nil,
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.邪恶狂热.root',
        ['user_data'] = user_data['$$default_units.spell.邪恶狂热'],
        ['event'] = event_register
    },
}
