...
local mt = {
    ['ActorMaterialCloak_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.镜像.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.镜像.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['AddBuff_2'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.镜像.Buff_2',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
                return 1
        ...
        ['NodeType'] = 'EffectAddBuff',
        ['Template'] = 'EffectAddBuff',
        ['Link'] = '$$default_units.spell.镜像.AddBuff_2',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['AddBuff_3'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.镜像.Buff_3',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
            local func = function (ref_param)
                return 1
        ...
        ['NodeType'] = 'EffectAddBuff',
        ['Template'] = 'EffectAddBuff',
        ['Link'] = '$$default_units.spell.镜像.AddBuff_3',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['BuffTargetsAddTarget_1'] = {
        ...
        ['WhichUnit'] = {
            ['Effect'] = '$$default_units.spell.镜像.Set_2',
            ['LocalVar'] = 'A',
            ['Value'] = 'Target',
        },
        ...
        ['Link'] = '$$default_units.spell.镜像.BuffTargetsAddTarget_1',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['BuffTargetsEnum_1'] = {
        ...
        ['Effect'] = '$$default_units.spell.镜像.UnitRemove_2',
        ['Name'] = 'Buff单位组 - 遍历节点_1',
        ['ResponseFlags'] = {
            ['Acquire'] = false,
            ['Flee'] = false,
        ...
        ['Link'] = '$$default_units.spell.镜像.BuffTargetsEnum_1',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['CreateUnit_1'] = {
        ...
        ['SpawnCount'] = 1,
        ['SpawnEffect'] = '$$default_units.spell.镜像.Set_2',
        ['SpawnOffset'] = {
            ['Angle'] = {
                ['LocalOffset'] = 0,
                ['Location'] = {
        ...
        ['Link'] = '$$default_units.spell.镜像.CreateUnit_1',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.镜像.BuffTargetsEnum_1',
            [2] = '$$default_units.spell.镜像.CreateUnit_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_1',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.镜像.Set_1',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['Set_2'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.镜像.AddBuff_2',
            [2] = '$$default_units.spell.镜像.AddBuff_1',
            [3] = '$$default_units.spell.镜像.BuffTargetsAddTarget_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合_2',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.镜像.Set_2',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['UnitRemove_1'] = {
        ...
        ['Link'] = '$$default_units.spell.镜像.UnitRemove_1',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['UnitRemove_2'] = {
        ...
        ['NodeType'] = 'EffectUnitRemove',
        ['Template'] = 'EffectUnitRemove',
        ['Link'] = '$$default_units.spell.镜像.UnitRemove_2',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['StartEffect'] = '$$default_units.spell.镜像.AddBuff_3',
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.镜像.root',
        ['user_data'] = user_data['$$default_units.spell.镜像'],
        ['event'] = event_register
    },
}
