...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.隐身术'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.隐身术.ActorEffect_2',
        },
        ['BuffLink'] = '$$default_units.spell.隐身术.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.隐身术.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.隐身术'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Search_1'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.隐身术.AddBuff_1',
        ['SearchFilter'] = '单位;敌方',
        ['SearchFlags'] = {
        ...
        ['Link'] = '$$default_units.spell.隐身术.Search_1',
        ['user_data'] = user_data['$$default_units.spell.隐身术'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.隐身术.root',
        ['user_data'] = user_data['$$default_units.spell.隐身术'],
        ['event'] = event_register
    },
}
