...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
    ...
    ['AddBuff_1'] = {
        ['ActorArray'] = nil,
        ['BuffLink'] = '$$default_units.spell.雷霆一击.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.雷霆一击.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['Damage_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.雷霆一击.ActorEffect_2',
        },
        ['Amount'] = (function ()
            local func = function (ref_param)
                return 60
        ...
        ['Link'] = '$$default_units.spell.雷霆一击.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
        ['event'] = event_register
    },
    ['Model_1'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.spell.雷霆一击.Model_1',
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
        ['event'] = event_register
    },
    ['Model_2'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.spell.雷霆一击.Model_2',
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
        ['event'] = event_register
    },
    ['Particle_2'] = {
    ...
    ['Search_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.雷霆一击.ActorEffect_3',
        },
        ['Angle'] = {
            ['LocalOffset'] = 0,
            ['Location'] = {
        ...
        ['SearchEffect'] = '$$default_units.spell.雷霆一击.Set_1',
        ...
        ['Link'] = '$$default_units.spell.雷霆一击.Search_1',
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
        ['event'] = event_register
    },
    ['Set_1'] = {
        ...
        ['EffectArray'] = {
            [1] = '$$default_units.spell.雷霆一击.Damage_1',
            [2] = '$$default_units.spell.雷霆一击.AddBuff_1',
        },
        ['MaxCount'] = -1,
        ['MinCount'] = -1,
        ['Name'] = '效果集合',
        ...
        ['NodeType'] = 'EffectSet',
        ['Template'] = 'EffectSet',
        ['Link'] = '$$default_units.spell.雷霆一击.Set_1',
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_09.ani',
        },
        ['EditorCategory'] = {
            [1] = 'Damage',
            [2] = 'Debuff',
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.雷霆一击.root',
        ['user_data'] = user_data['$$default_units.spell.雷霆一击'],
        ['event'] = event_register
    },
}
