...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.震荡波'],
        ['event'] = event_register
    },
    ['Damage_1'] = {
        ['ActorArray'] = {
            [1] = '$$default_units.spell.震荡波.ActorEffect_1',
        },
        ['Amount'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.震荡波.Damage_1',
        ['user_data'] = user_data['$$default_units.spell.震荡波'],
        ['event'] = event_register
    },
    ['LaunchMissile_1'] = {
        ...
        ['ImpactEffect'] = '$$default_units.spell.震荡波.Damage_1',
        ...
        ['ImpactSearchFilter'] = '敌方,单位;无敌,物免,死亡',
        ...
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.spell.震荡波.UnitMissile_1',
        ['Name'] = '发射投射物节点(碰撞中途单位)',
        ...
        ['Link'] = '$$default_units.spell.震荡波.LaunchMissile_1',
        ['user_data'] = user_data['$$default_units.spell.震荡波'],
        ['event'] = event_register
    },
    ['Model_1'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.spell.震荡波.Model_1',
        ['user_data'] = user_data['$$default_units.spell.震荡波'],
        ['event'] = event_register
    },
    ['UnitMissile_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.spell.震荡波.UnitMissile_1',
        ['user_data'] = user_data['$$default_units.spell.震荡波'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['DefaultAnimationList'] = {
            [1] = 'human/barehanded_anim/hand_05/skill_028.ani',
        },
        ['EditorCategory'] = {
            [1] = 'Damage',
        },
        ...
        ['SpellAnim'] = {
            ['Animation'] = 'human/barehanded_anim/hand_05/skill_028.ani',
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.震荡波.root',
        ['user_data'] = user_data['$$default_units.spell.震荡波'],
        ['event'] = event_register
    },
}
