...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.spell.魔法免疫（被动）'],
        ['event'] = event_register
    },
    ['AddBuff_1'] = {
        ['ActorArray'] = {
        },
        ['BuffLink'] = '$$default_units.spell.魔法免疫（被动）.Buff_1',
        ['CanBeBlocked'] = true,
        ['Chance'] = (function ()
        ...
        ['Link'] = '$$default_units.spell.魔法免疫（被动）.AddBuff_1',
        ['user_data'] = user_data['$$default_units.spell.魔法免疫（被动）'],
        ['event'] = event_register
    },
    ['Buff_1'] = {
    ...
    ['root'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.spell.魔法免疫（被动）.root',
        ['user_data'] = user_data['$$default_units.spell.魔法免疫（被动）'],
        ['event'] = event_register
    },
}
