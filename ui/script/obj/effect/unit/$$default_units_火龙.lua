...
local mt = {
    ['ActorEffect_1'] = {
        ...
        ['user_data'] = user_data['$$default_units.unit.火龙'],
    ...
    ['Damage_1'] = {
        ...
        ['Link'] = '$$default_units.unit.火龙.Damage_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['Damage_1_1'] = {
        ...
        ['NodeType'] = 'EffectDamage',
        ['Template'] = 'EffectDamage',
        ['Link'] = '$$default_units.unit.火龙.Damage_1_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['LaunchMissile_1'] = {
        ...
        ['FinishEffect'] = '',
        ['ImpactActors'] = {
            [1] = '$$default_units.unit.火龙.ActorEffect_1',
        },
        ['ImpactEffect'] = '$$default_units.unit.火龙.Damage_1',
        ...
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.unit.火龙.UnitMissile_1',
        ['Name'] = '发射投射物节点_1',
        ...
        ['Link'] = '$$default_units.unit.火龙.LaunchMissile_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['LaunchMissile_1_1'] = {
        ...
        ['FinishEffect'] = '',
        ['ImpactActors'] = {
            [1] = '$$default_units.unit.火龙.ActorEffect_1_1',
        },
        ['ImpactEffect'] = '$$default_units.unit.火龙.Damage_1_1',
        ['ImpactFinalTargetRadius'] = 0,
        ['ImpactMaxCount'] = (function ()
            local func = function (ref_param)
                return 1
        ...
        ['LaunchTargetType'] = 'Point',
        ['Method'] = 'New',
        ['MissileType'] = '$$default_units.unit.火龙.UnitMissile_1_1',
        ['Name'] = '发射投射物节点_1',
        ['ParabolaApex'] = (function ()
            local func = function (ref_param)
                return 0
        ...
        ['NodeType'] = 'EffectLaunchMissile',
        ['Template'] = 'EffectLaunchMissile',
        ['Link'] = '$$default_units.unit.火龙.LaunchMissile_1_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['Model_1'] = {
        ...
        ['NodeType'] = 'Model',
        ['Template'] = 'Model',
        ['Link'] = '$$default_units.unit.火龙.Model_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['Particle_1'] = {
    ...
    ['PersistLoop_1'] = {
        ...
        ['PeriodicEffect'] = '$$default_units.unit.火龙.PolarOffset_1',
        ['PersistFlags'] = {
            ['Channeled'] = false,
            ['Channeling'] = false,
            ['FinishStage'] = false,
        ...
        ['Link'] = '$$default_units.unit.火龙.PersistLoop_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['PolarOffset_1'] = {
        ...
        ['PointLocalVar'] = '',
        ['SuppressValidatorFailOutput'] = false,
        ['TargetEffect'] = '$$default_units.unit.火龙.LaunchMissile_1_1',
        ['TargetLocation'] = {
            ['Effect'] = '',
            ['LocalVar'] = 'A',
            ['Value'] = 'Default',
        ...
        ['Link'] = '$$default_units.unit.火龙.PolarOffset_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['SpellRootVector_1'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.unit.火龙.SpellRootVector_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['SpellRootVector_2'] = {
        ...
        ['NodeType'] = 'SpellRoot',
        ['Template'] = 'SpellRoot',
        ['Link'] = '$$default_units.unit.火龙.SpellRootVector_2',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['UnitMissile_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.unit.火龙.UnitMissile_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['UnitMissile_1_1'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.unit.火龙.UnitMissile_1_1',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
    ['root'] = {
        ...
        ['NodeType'] = 'Unit',
        ['Template'] = 'Unit',
        ['Link'] = '$$default_units.unit.火龙.root',
        ['user_data'] = user_data['$$default_units.unit.火龙'],
        ['event'] = event_register
    },
}
